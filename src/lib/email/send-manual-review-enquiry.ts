...
export async function sendManualReviewEnquiryEmail(
  ...
  console.log(
    "Manual review admin email accepted by Resend:",
    {
      to:
        adminEmail,
